...
namespace CrashKonijn.Goap.Demos.Complex.Actions {
    public class CreateItemAction<TCreatable> : GoapActionBase<CreateItemAction<TCreatable>.Data, CreateItemAction<TCreatable>.Props>, IInjectable where TCreatable : ItemBase, ICreatable {
